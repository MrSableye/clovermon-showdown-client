...
const BattlePokemonIconIndexes: {[id: string]: number} = {
	...
	// CAP Formes
	jerminswarm: 1379 + (49 * 12) + 1,
	skubaanti: 1379 + (49 * 12) + 2,
	disbearyebil: 1379 + (49 * 12) + 3,
	gargarramerawoken: 1379 + (49 * 12) + 4,

	// Blobbos CAP
	blobboshenesys: 1379 + (50 * 12) + 1,
	blobbosnega: 1379 + (50 * 12) + 2,
	blobbosreverse: 1379 + (50 * 12) + 3,
	blobbosgalar: 1379 + (50 * 12) + 4,
	blobbosvalian: 1379 + (50 * 12) + 5,
	blobbosdouble: 1379 + (50 * 12) + 6,
	bootlos: 1379 + (50 * 12) + 7,
	blobbosunova: 1379 + (50 * 12) + 8,
	blobbosshining: 1379 + (50 * 12) + 9,
	blobbosmagic: 1379 + (50 * 12) + 10,
	blobbosultra: 1379 + (50 * 12) + 11,
	blobbosking: 1379 + (50 * 12) + 12,
	blobbosangel: 1379 + (50 * 12) + 13,
	blobbosnonfungible: 1379 + (50 * 12) + 14,
	blobbosnice: 1379 + (50 * 12) + 15,
	blobbosalola: 1379 + (50 * 12) + 16,
	blobbosarceus: 1379 + (50 * 12) + 17,
	blobboschad: 1379 + (50 * 12) + 18,
	blobbosgnome: 1379 + (50 * 12) + 19,
	blobbosmini: 1379 + (50 * 12) + 20,
	blobbosdust: 1379 + (50 * 12) + 21,
	blobbostherian: 1379 + (50 * 12) + 22,
	blobbospostmodern: 1379 + (50 * 12) + 23,
	blobbosfnaf: 1379 + (50 * 12) + 24,
	blobbostrips: 1379 + (50 * 12) + 25,
	blobbosbirb: 1379 + (50 * 12) + 26,
	blobbosathlete: 1379 + (50 * 12) + 27,
	blobbosgay: 1379 + (50 * 12) + 28,
	blobbosmountain: 1379 + (50 * 12) + 29,
	blobbospika: 1379 + (50 * 12) + 30,
	blobboschef: 1379 + (50 * 12) + 31,
	blobbosmexican: 1379 + (50 * 12) + 32,
	blobbosfish: 1379 + (50 * 12) + 33,
	blobbospizza: 1379 + (50 * 12) + 34,
	blobbosnightmare: 1379 + (50 * 12) + 35,
	blobboshoenn: 1379 + (50 * 12) + 36,
	blobboskirby: 1379 + (50 * 12) + 37,
	blobbosjackolantern: 1379 + (50 * 12) + 38,
	blobboseggdog: 1379 + (50 * 12) + 39,
	blobbosmetal: 1379 + (50 * 12) + 40,
	blobbosadesign: 1379 + (50 * 12) + 41,
	blobbosexplosion: 1379 + (50 * 12) + 42,
	blobboskalos: 1379 + (50 * 12) + 43,
	blobbosmega: 1379 + (50 * 12) + 44,
	blobboselectric: 1379 + (50 * 12) + 45,
	blobbosomori: 1379 + (50 * 12) + 46,
	blobbossneed: 1379 + (50 * 12) + 47,
	blobbossus: 1379 + (50 * 12) + 48,
	blobbostandor: 1379 + (50 * 12) + 49,
};
