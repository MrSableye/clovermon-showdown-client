...
export const BattleMoveAnims: AnimTable = {
	...
	gayagenda: {
		anim(scene, [attacker, defender]) {
         ...
         scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/gay.png')`, 800, 1);
	...
	morningsun: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-sunnyday.jpg')`, 700, 0.5);
			scene.showEffect('wisp', {
				x: attacker.x + 40,
				y: attacker.y - 40,
				z: attacker.z,
	...
	moonlight: {
		anim(scene, [attacker]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 800, 0.6);
			scene.showEffect('shine', {
				x: attacker.x + 40,
				y: attacker.y - 40,
				z: attacker.z,
	...
	cosmicpower: {
		anim(scene, [attacker]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 600, 0.6);
			scene.showEffect('wisp', {
				x: attacker.x + 40,
				y: attacker.y - 40,
				z: attacker.z,
	...
	seismictoss: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 500, 0.6, 300);
			scene.showEffect('wisp', {
				x: defender.x,
				y: defender.y + 10,
				z: defender.z,
	...
	meteormash: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 1000, 0.4);
			scene.showEffect(attacker.sp, {
	...
	psystrike: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-psychicterrain.png')`, 950, 0.6);
			scene.showEffect('poisonwisp', {
				x: defender.x - 100,
				y: defender.y,
				z: defender.z,
	...
	wish: {
		anim(scene, [attacker]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 600, 0.4);
	...
	solarbeam: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-sunnyday.jpg')`, 900, 0.5);
	...
	meteorbeam: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-sandstorm.png')`, 900, 0.5);
	...
	dragonascent: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 1000, 0.7);
			scene.showEffect('iceball', {
	...
	plasmafists: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2000, 1);
	...
	oceanicoperetta: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-raindance.jpg')`, 700, 0.2, 2000);
			scene.showEffect('iceball', {
				x: attacker.x,
				y: attacker.y + 120,
				z: attacker.z,
	...
	splinteredstormshards: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2700, 0.8, 300);
	...
	clangoroussoulblaze: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2000, 0.7, 300);
	...
	overbite: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#BF0040', 800, 0.5);
			scene.showEffect('topbite', {
				x: defender.x,
				y: defender.y + 70,
				z: defender.z,
	...
	fruitpunch: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-mistyterrain.png')`, 1000, 0.4);
			scene.showEffect(attacker.sp, {
				x: attacker.leftof(20),
				y: attacker.y,
				z: attacker.behind(-25),
	...
	crusadercrash: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 1000, 0.3);
			scene.showEffect('shadowball', {
				x: defender.x,
				y: defender.y,
				z: defender.behind(-100),
	...
	cosmiccrunch: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 2500, 1);
			scene.showEffect('topbite', {
				x: defender.x,
				y: defender.y + 70,
				z: defender.z,
	...
	cometrain: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-hail.png')`, 700, 1);
			scene.showEffect('flareball', {
				x: defender.leftof(-200),
				y: defender.y + 175,
				z: defender.z,
	...
	soulcrusher: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#440044 30%, #000000', 1500, 1);
			let xstep = (defender.x + 200 - defender.x) / 5;
			let ystep = (defender.x - 200 - defender.x) / 5;
			let zstep = defender.z / 5;
	...
	shadowscales: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#043B13 55%, #3FBF99', 800, 0.8);
			scene.showEffect('shadowball', {
				x: attacker.x,
				y: attacker.y + 45,
				z: attacker.z,
	...
	searingsunrazesmash: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-trickroom.png')`, 700, 1);
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 2500, 1, 700);
	...
	brainblast: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#000000', 500, 0.7);
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-psychicterrain.png')`, 600, 0.4);
			scene.showEffect('mistball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	raindestruction: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 1100, 1);
			scene.showEffect('flareball', {
				x: defender.leftof(-200),
				y: defender.y + 175,
				z: defender.z,
	...
	brandingblade: {
		anim(scene, [attacker, defender]) {
			...
			let ystep = 20;
			let zstep = 0;
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 900, 1);
	...
	skullcannon: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect('#000000', 700, 1);
	...
	elbowdrop: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)', 1300, 0.5);
			scene.showEffect(attacker.sp, {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	lactoseshot: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-mistyterrain.png')`, 700, 0.5);
			scene.showEffect('wisp', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	chaosdunk: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 1200, 1);
			scene.showEffect('impact', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
	...
	enema: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-grassyterrain.png')`, 800, 0.4);
			scene.showEffect('energyball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	plunder: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-raindance.jpg')`, 900, 0.5);
			scene.showEffect('waterwisp', {
				x: defender.x,
				y: defender.y + 80,
				z: defender.behind(-15),
	...
	dragonburst: {
		anim(scene, [attacker, ...defenders]) {
			scene.backgroundEffect('#082179', 1600, 0.5, 300);
			scene.backgroundEffect('linear-gradient(#000000 20%, #2630A9)', 1600, 0.4, 300);
	...
	sleppthatblobsthesky: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-space.jpg')`, 900, 1);
			scene.backgroundEffect('#BF0040', 900, 0.5);
			scene.showEffect('iceball', {
				x: attacker.x,
				y: attacker.y + 90,
	...
	atomicfire: {
		...
		prepareAnim: BattleOtherAnims.atomize.anim,
	},
	leafshield: {
		anim(scene, [attacker]) {
			let xf = [1, -1, 1, -1];
	...
	frigidend: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/weather-densefog.png')`, 900, 0.5);
	...
	beamblade: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#0af5f5', 700, 0.6);
			scene.showEffect('rightslash', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.behind(-30),
	...
	cherrybomb: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#ffffff', 550, 0.6);
			scene.backgroundEffect('#ffffff', 750, 0.6);
			scene.showEffect('flareball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	charmerssong: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect('linear-gradient(#440044 30%, #000000', 90, 0.7);
			scene.showEffect('shadowball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	portalgun: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect('#FC6F03', 700, 0.3);
			scene.showEffect('flareball', {
				x: defender.x,
				y: defender.y - 50,
				z: defender.z,
	...
	heavensblessing: {
		anim(scene, [attacker]) {
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/weather-strongwind.png')`, 600, 0.4);
	...
	sandysnore: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect('linear-gradient(#390000 30%, #B84038)', 900, 0.4);
			scene.showEffect('iceball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	amogus: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/bg-space.jpg')`, 1600, 0.7);
			scene.showEffect('shine', {
				x: attacker.x + 50,
				y: attacker.y + 30,
				z: attacker.z,
	...
	toxicbeam: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#000000', 500, 0.7);
			scene.backgroundEffect('linear-gradient(#440044 30%, #000000', 600, 0.4, 500);
			scene.showEffect('shadowball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	destructionstinger: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#000000', 330, 0.6);
			scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)', 1100, 0.6, 330);
			scene.showEffect('shadowball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	extinctionwave: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect('#000000', 700, 0.6);
			scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)', 700, 0.6, 330);
			scene.showEffect('blackwisp', {
				x: attacker.x,
				y: attacker.y - 25,
				z: attacker.z,
	...
	poisonbullet: {
		...
		prepareAnim: BattleOtherAnims.poisonpulse.anim,
	},
	flashbang: {
		anim(scene, [attacker, defender]) {
			scene.showEffect('wisp', {
	...
	ballkick: {
		anim(scene, [attacker, defender]) {
			...
			BattleOtherAnims.kickattack.anim(scene, [attacker, defender]);
		},
	},
	saltsprinkle: {
		anim(scene, [attacker, defender]) {
	...
	feedandseed: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-sneed.png')`, 800, 1);
			scene.showEffect('energyball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	extremesneed: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/fx/bg-sneed.png')`, 1050, 1);
			scene.showEffect('wisp', {
				x: attacker.x,
				y: attacker.y - 30,
				z: attacker.z,
	...
	dousingflame: {
		anim(scene, [attacker, defender]) {
			BattleOtherAnims.redhydroshot.anim(scene, [attacker, defender]);
			scene.showEffect('wisp', {
				x: defender.x + 30,
				y: defender.y,
				z: defender.z,
	...
	laserbeam: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#2630A9', 700, 0.3);
			scene.showEffect('mistball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	icestorm: { // todo: better blizzard anim
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('${Config.routes.clientProtocol}://${Config.routes.client}/sprites/gen6bgs/bg-icecave.jpg')`, 1000, 0.6);
			scene.showEffect('icicle', {
				x: attacker.x,
	...
	bloodshot: { // todo: new animation involving icicles
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#FF99FF', 700, 0.3);
			scene.showEffect('bloodwisp', {
				x: attacker.x,
	...
	trapcard: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#f542ff', 800, 0.3, 400);
			scene.showEffect('heart', {
				x: defender.x,
				y: defender.y + 75,
				z: defender.z,
...
BattleMoveAnims['energyburst'] = {anim: BattleMoveAnims['terrainpulse'].anim};
BattleMoveAnims['blobblast'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['coreenforcer'].anim(scene, [attacker, defender]);
		BattleMoveAnims['dragonenergy'].anim(scene, [attacker, defender]);
		BattleMoveAnims['dragonpulse'].anim(scene, [attacker, defender]);
	},
}; 
BattleMoveAnims['xenobeam'] = {anim: BattleMoveAnims['gazerbeam'].anim};
...
BattleMoveAnims['mushroomshot'] = {anim: BattleMoveAnims['bulletseed'].anim};
...
BattleMoveAnims['terradozer'] = {anim: BattleMoveAnims['earthquake'].anim};
...
BattleMoveAnims['paranormalactivity'] = {anim: BattleMoveAnims['neverendingnightmare'].anim};
...
BattleMoveAnims['sandblast'] = {anim: BattleMoveAnims['diamondstorm'].anim};
...
BattleMoveAnims['surgingstrikes'] = {anim: BattleMoveAnims['jetpunch'].anim};
...
BattleMoveAnims['nosedive'] = {anim: BattleMoveAnims['bravebird'].anim};
...
BattleMoveAnims['behemothblob'] = {anim: BattleMoveAnims['behemothblade'].anim};
BattleMoveAnims['obsidianhorn'] = {anim: BattleMoveAnims['headsmash'].anim};
BattleMoveAnims['backroom'] = {anim: BattleMoveAnims['uturn'].anim};
BattleMoveAnims['rainbowbeam'] = {anim: BattleMoveAnims['lightofruin'].anim};
BattleMoveAnims['ultima'] = {anim: BattleMoveAnims['fusionflare'].anim};
BattleMoveAnims['needlepulse'] = {anim: BattleMoveAnims['energyball'].anim};
BattleMoveAnims['carcrash'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['rollout'].anim(scene, [attacker, defender]);
		BattleMoveAnims['headsmash'].anim(scene, [attacker, defender]);
	},
}; 
...
BattleMoveAnims['sugarrush'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['geomancy'].anim(scene, [attacker, defender]);
		BattleMoveAnims['milkdrink'].anim(scene, [attacker, defender]);
	},
}; 
BattleMoveAnims['deepfry'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['firelash'].anim(scene, [attacker, defender]);
		BattleMoveAnims['inferno'].anim(scene, [attacker, defender]);
	},
};
BattleMoveAnims['bellyflop'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['plunder'].anim(scene, [attacker, defender]);
		BattleMoveAnims['bodyslam'].anim(scene, [attacker, defender]);
	},
};
BattleMoveAnims['infectiouswheeze'] = {
	anim(scene, [attacker, defender]) {
...
BattleMoveAnims['tridentcharge'] = {anim: BattleMoveAnims['flamewheel'].anim};
BattleMoveAnims['devilsbarrage'] = {anim: BattleMoveAnims['barrage'].anim};
BattleMoveAnims['rebuild'] = {anim: BattleMoveAnims['shiftgear'].anim};
BattleMoveAnims['invigorate'] = {anim: BattleMoveAnims['recover'].anim};
BattleMoveAnims['heavenpierce'] = {anim: BattleMoveAnims['drillrun'].anim};
BattleMoveAnims['flurryfist'] = {anim: BattleMoveAnims['jetpunch'].anim};
BattleMoveAnims['genesisbeam'] = {anim: BattleMoveAnims['signalbeam'].anim};
BattleMoveAnims['genesiswhirl'] = {anim: BattleMoveAnims['naturesmadness'].anim};
BattleMoveAnims['genesisflash'] = {anim: BattleMoveAnims['fusionflare'].anim};
BattleMoveAnims['genesisblast'] = {anim: BattleMoveAnims['laserbeam'].anim};
BattleMoveAnims['bouncyball'] = {anim: BattleMoveAnims['splash'].anim};
BattleMoveAnims['glacialgroove'] = {anim: BattleMoveAnims['hypervoice'].anim};
BattleMoveAnims['scarystory'] = {anim: BattleMoveAnims['partingshot'].anim};
BattleMoveAnims['hornithrust'] = {anim: BattleMoveAnims['bodyslam'].anim};
BattleMoveAnims['unload'] = {anim: BattleMoveAnims['vacuumwave'].anim};
BattleMoveAnims['mouthmelter'] = {anim: BattleMoveAnims['poisonfang'].anim};
BattleMoveAnims['helldive'] = {anim: BattleMoveAnims['spectralthief'].anim};
BattleMoveAnims['shuttleloop'] = {anim: BattleMoveAnims['aerialace'].anim};
BattleMoveAnims['flashfreeze'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['iceshard'].anim(scene, [attacker, defender]);
		BattleMoveAnims['flash'].anim(scene, [attacker, defender]);
	},
};
...
BattleMoveAnims['dustbowl'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['sandattack'].anim(scene, [attacker, defender]);
		BattleMoveAnims['quicksand'].anim(scene, [attacker, defender]);
		BattleMoveAnims['earthpower'].anim(scene, [attacker, defender]);
	},
};
...
BattleMoveAnims['tombstonerd'] = {anim: BattleMoveAnims['rocktomb'].anim};
BattleMoveAnims['highjumpsaw'] = {anim: BattleMoveAnims['spinout'].anim};
BattleMoveAnims['glomp:3'] = {anim: BattleMoveAnims['splash'].anim};
BattleMoveAnims['scryingwish'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['wish'].anim(scene, [attacker, defender]);
		BattleMoveAnims['doomdesire'].anim(scene, [attacker, defender]);
	},
};
...
BattleMoveAnims['bugout'] = {
	anim(scene, [attacker, defender]) {
		...
		BattleMoveAnims['megahorn'].anim(scene, [attacker, defender]);
	},
};
...
BattleMoveAnims['lasagnatoss'] = {anim: BattleMoveAnims['fling'].anim};
BattleMoveAnims['bombrock'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['mindblown'].anim(scene, [attacker, defender]);
		BattleMoveAnims['rockthrow'].anim(scene, [attacker, defender]);
		BattleMoveAnims['explosion'].anim(scene, [attacker, defender]);
	},
};
...
BattleMoveAnims['hardcrash'] = {
	anim(scene, [attacker, defender]) {
		...
		BattleMoveAnims['this'].anim(scene, [attacker, defender]);
		BattleMoveAnims['overenergize'].anim(scene, [attacker, defender]);
...
BattleMoveAnims['mawofsight'] = {anim: BattleMoveAnims['crunch'].anim};
BattleMoveAnims['orbponder'] = {anim: BattleMoveAnims['nastyplot'].anim};
